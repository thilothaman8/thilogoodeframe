...
<?php include APPPATH.'views/includes/header.php';?>
   	<nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
			...
			<li class="breadcrumb-item active" aria-current="page">Scan Schedule Shipment</li>
        </ol>
    </nav>
	<div class = "container">
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span>Scan Schedule Shipment</h4>
		</div>
	</div>
	<section class="hk-sec-wrapper">
		<div class="panel-heading">
				<h5 class="panel-title">Scan Schedule Shipment</h5>
		</div><br>
             ...
             <div class="row">
                <div class="col-sm">
                    <div class="row">  
						<div class="col-md-3">
							<label>From </label>
							<input type="date" ng-model="from_date" class="form-control ng-pristine ng-untouched ng-valid ng-empty">
						</div>
						
						 <div class="col-md-3">
							<label>To </label>
							<input type="date" ng-model="to_date" class="form-control ng-pristine ng-untouched ng-valid ng-empty">
						</div>
