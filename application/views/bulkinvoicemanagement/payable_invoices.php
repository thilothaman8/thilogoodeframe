...
<body>
   ...
   <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
					...
					<li class="breadcrumb-item active" aria-current="page">Payable Invoices</li>
                </ol>
    </nav>
	<div class = "container">
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span>Payable Invoices</h4>
		</div>
	</div>
	<section class="hk-sec-wrapper">
	<h5 class="hk-sec-title">Payable Invoice</h5>
	<div class="row">
			<div class="col-md-12">
...
<table class="table datatable-show-all table-bordered table-hover datatable-highlight">
       ...
       <tr>
	    ...
	    <tr>
			...
			<td>admin</td>
			<td> 12- 11 -2019 </td>
			<td><a data-toggle="modal" class="btn btn-info" data-target="#updateLinehoul1R51201961561904494" title="Received"> Received</a>
			</td>
			<td>
			<a href="" target="_blank" class="btn btn-primary">View  Invoice </a>
			</td>
        </tr>
	...
	<tr>
        ...
        <td>--</td>
        <td> -- </td>
        <td><a data-toggle="modal" class="btn btn-danger" data-target="#updateLinehoulR51201971563785355" title="Receive">Receive</a>
		</td>
        <td>
        <a href="" target="_blank" class="btn btn-primary">View  Invoice </a>
        </td>
