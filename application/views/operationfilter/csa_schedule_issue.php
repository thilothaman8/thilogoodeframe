   ...
   <?php include APPPATH.'views/includes/header.php';?>
     <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
					...
					<li class="breadcrumb-item active" aria-current="page">CSA Schedule Issue</li>
                </ol>
    </nav>
	<div class = "container">
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span>CSA Schedule Issue</h4>
		</div>
	</div>
	<section class="hk-sec-wrapper">
	<h5 class="hk-sec-title">CSA Schedule Issue</h5>Shipment which not assigning to CS for calling since 3 days<br>
	<section class="hk-sec-wrapper">
	<div class="row">
