...
<?php include APPPATH.'views/includes/header.php';?>
	...
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span>Add Customer</h4>
		</div>
	</div>
	<section class="hk-sec-wrapper">
		...
		<div class="panel-body">
                    ...
                    <div class="form-group">
						...
						<input type="text" name="uniqueid" readonly="1" class="form-control" value="8216374">
						</p>
					</div>
                    ...
                    <div class="form-group">
						...
						<input type="text" name="onhold_period" class="form-control" id="onhold_period" value="">
                    </div>
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control" name="managerEmail" id="account_manager" value="">
                    </div> 
                    ...
                    <label class="custom-file-label" for="validatedCustomFile">Upload ID (pdf)..</label>
					</div>
					
					<div class="custom-file"><br>
                    <input type="file" class="custom-file-input" id="validatedCustomFile1" required>
                    <label class="custom-file-label" for="validatedCustomFile1">Contract Date..</label>
					</div>
					
					<div class="custom-file"><br>
                    <input type="file" class="custom-file-input" id="validatedCustomFile2" required>
                    <label class="custom-file-label" for="validatedCustomFile2">Vat No..</label>
					</div>
                    ...
                    <input type="password" class="form-control" name="password" id="alert_password" value="">                      
					</div>
