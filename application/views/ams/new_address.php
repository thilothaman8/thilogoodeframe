 ...
 <?php include APPPATH.'views/includes/header.php';?>
	...
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span>Add New Address</h4>
		</div>
	</div>
					...
					<div class="row">
                        <div class="col-sm">
                            <div class="row">
								...
								<div class="col-sm-6"><br>
									<label>Address</label>
									 <textarea rows="6" id="show_awb_no" class="form-control"></textarea>
                                </div>	
								<div class="col-sm-6"><br>
									<label>E-mail</label>
								...
								<div class="col-sm-12"><br> <button type="submit" class="btn btn-primary" name="submit_suplier" value="Submit">  Add </button> </div>  
