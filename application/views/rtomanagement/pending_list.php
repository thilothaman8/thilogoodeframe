...
<?php include APPPATH.'views/includes/header.php';?>
        ...
        <ol class="breadcrumb breadcrumb-light bg-transparent">
			...
			<li class="breadcrumb-item active" aria-current="page"> Show Pending RTO List</li>
        </ol>
    </nav>
	<div class = "container">
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span> Show Pending RTO List</h4>
		</div>
	</div>
	<section class="hk-sec-wrapper">
		<div class="panel-heading">
				<h5 class="panel-title"> Show Pending RTO List</h5>
		</div><br>
		 <table class="table table-hover table-bordered mb-0">
				...
				<tbody>
				    <tr>
						...
						<td>Fastcoo</td>
						<td></td>
						<td><span class="btn btn-outline-danger btn-rounded btn-xs">RTO PEnding(7/7)</span></td>
						<td> 
