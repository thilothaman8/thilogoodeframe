...
<body>
 <?php include APPPATH.'views/includes/header.php';?>
	...
	<section class="hk-sec-wrapper">
		...
		<form class="stdform" method="post" action="" name="add_Supplier" enctype="multipart/form-data"> 
                    ...
                    <div class="form-group">
                    <label>Phone</label>
                    <input type="tel" maxlength="10" minlength="10" name="mobile" class="form-control" id="phone" value="">
                                        </div>
                    
                    <div class="form-group">
                    <label>Rate per Delivery</label>
                    <input type="number" maxlength="10" minlength="1" name="rate" class="form-control" id="phone" value="">
                                        </div>
                    
					<div class="form-group">
                     <label> Contract Date </label>
                    <input class="form-control" type="date" name="entry_date" id="entrydate" value="">  
                     </div>
					 <div class="form-group">
						<label> Vat No</label>
						<input class="form-control" type="text" name="vat_no" id="vat_no" value="">  
                     </div>
					<div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary" name="submit_suplier" value="Submit"> Add Supplier </button>
