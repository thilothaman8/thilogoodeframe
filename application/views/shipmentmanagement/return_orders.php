	...
	<table id="testTable_new" class="table table-striped table-bordered table-hover" align="center">
			...
			<tbody>
			    <tr>
					...
					<td>Monday, August 12, 2019 09:56:51 PM</td>
					<td>645679</td>
					<td>-</td>
					<td><a href="" target="_blank">TAM5941007029</a><br></td>
					<td>0</td>
					<td>1</td>
					<td>Riyadh</td>
					<td>Riyadh</td>
					<td>1</td>
					<td>SHENZHEN YOKESI SCP CO.,LIMITED</td>
					<td><a href="" target="_blank">Fernando chito</a><br></td>
					<td>N/A</td>
					<td></td>
					<td style="background-color:#AEFFAE;">
				    <span></span><i class="icon" data-icon="q"></i> Return  (399.00) (Forward to HUB )
			        </td>
				 ...
				 <tr>
					...
					<td>10</td>
					<td>Shopify</td>
					<td><a href="" target="_blank">افنان خالد</a><br></td></td>
					<td>N/A</td>
					<td></td>
					<td style="background-color:#AEFFAE;">
				    <span><i class="icon" data-icon="q"></i>  Return  (299.00) (Forward to HUB )
			        </td>
					<td><span class="btn btn-danger btn-wth-icon icon-wthot-bg btn-sm btn-rounded btn-xs">Pending</span></td>
					<td></td>
					<td></td>
				 ...
				 <tr>
				    <td>3<br/><input type="checkbox" onclick="toggle(this)" name="selectAll[]" value=""/>
					...
					<td>10</td>
					<td>Shopify</td>
					<td><a href="" target="_blank">عبد الفتاح الخيامي عبد الفتاح</a><br></td></td>
					<td>N/A</td>
					<td></td>
					<td style="background-color:#AEFFAE;">
				    <span></span><i class="icon" data-icon="q"></i>  Return  (199.00) (Forward to HUB )
			        </td>
					<td><span class="btn btn-danger btn-wth-icon icon-wthot-bg btn-sm btn-rounded btn-xs">Pending</span></td>
					<td></td>
					<td></td>
