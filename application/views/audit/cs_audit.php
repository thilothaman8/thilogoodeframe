   ...
   <?php include APPPATH.'views/includes/header.php';?>
   	<nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
					...
					<li class="breadcrumb-item active" aria-current="page">CS Audit</li>
                </ol>
    </nav>
	<div class = "container">
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span>CS Audit</h4>
		</div>
	</div>
	<section class="hk-sec-wrapper">
	<h5 class="panel-title">CS Audit &nbsp;<i class="fa fa-check-circle" style="font-size:15px;color:green">&nbsp;Complete Orders :</b></i>&nbsp;&nbsp;<i class="fa fa-warning" style="font-size:15px;color:red">&nbsp;Pending Orders :</b></i></h5><br>
