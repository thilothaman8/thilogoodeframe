...
<?php include APPPATH.'views/includes/header.php';?>
   	<nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
			...
			<li class="breadcrumb-item active" aria-current="page">Show COD Shipment</li>
        </ol>
    </nav>
	<div class = "container">
	<div class="breadcrumb-line">
	    <div class="hk-pg-header">
            ...
            <span class="text-semibold"></span>Show COD Shipment</h4>
		</div>
	</div>
	<section class="hk-sec-wrapper">
		<div class="panel-heading">
				<h5 class="panel-title">Show COD Shipment</h5>
		</div><br>
		<div class="panel-heading">
			...
			<tbody>
			    <tr>
                    ...
                    <td class="text-center">
					 <a class="btn btn-primary btn-xs" style="background-color:green;">Confirmed</a>
                    </td>
				</tr>
				<tr>
					<td>2</td>
