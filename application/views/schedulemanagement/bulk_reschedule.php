	...
	<section class="hk-sec-wrapper">
      ...
      <div class="panel-body">
        ...
        <div class="col-md-4">
            ...
            <input type="date" name="date" class="form-control myinput" placeholder="Date" value="1573894545" required="">
          ...
          <div class="col-md-4">
            ...
            <label>&nbsp;</label>
            <button type="submit" name="Schedule_submitbtn" class="btn btn-primary form-control">Reschedule</button>
